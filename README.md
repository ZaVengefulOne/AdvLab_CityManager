...
4. **Настройте переменные окружения:**
   ...
   - `DATABASE_PASSWORD` — пароль от базы данных PostgreSQL
   ...
   **Запуск сервера с переменными окружения:**
   ...
   Linux/macOS:
   Запустите sh-скрипт `enviromentScripts/macOs_script`

   Windows (PowerShell):
   Запустите bat-скрипт `enviromentScripts/windows_script`
